    ...
    -->
          ...
          >
            ...
            >
              <button
                type="button"
                @click="this.nameFilledUponSubmit = false"
...
export default {
  ...
  methods: {
    ...
    calculate() {
      console.log(parseInt(this.client.birthday));
      this.age = 2021 - parseInt(this.client.birthday);
      return;
      //2021 - parseInt(this.client.birthday.toISOString().slice(0, 4));
    },
  },
};
</script>
